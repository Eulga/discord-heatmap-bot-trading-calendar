...
NEWS_BRIEFING_ENABLED = _env_bool("NEWS_BRIEFING_ENABLED", False)
...
STOCK_DASHBOARD_ALERT_POLL_INTERVAL_SECONDS = max(
    15,
    min(_env_int("STOCK_DASHBOARD_ALERT_POLL_INTERVAL_SECONDS", 15), 600),
)
STOCK_DASHBOARD_NEWS_DELIVERY_ENABLED = _env_bool("STOCK_DASHBOARD_NEWS_DELIVERY_ENABLED", True)
STOCK_DASHBOARD_NEWS_MAX_PER_BATCH = max(1, min(_env_int("STOCK_DASHBOARD_NEWS_MAX_PER_BATCH", 10), 10))
STOCK_DASHBOARD_NEWS_POLL_INTERVAL_SECONDS = max(
    30,
    min(_env_int("STOCK_DASHBOARD_NEWS_POLL_INTERVAL_SECONDS", 30), 1800),
)
STOCK_DASHBOARD_REPORT_DELIVERY_ENABLED = _env_bool("STOCK_DASHBOARD_REPORT_DELIVERY_ENABLED", True)
STOCK_DASHBOARD_REPORT_GENERATION_ENABLED = _env_bool("STOCK_DASHBOARD_REPORT_GENERATION_ENABLED", True)
STOCK_DASHBOARD_REPORT_MORNING_TIME = os.getenv("STOCK_DASHBOARD_REPORT_MORNING_TIME", "07:30").strip() or "07:30"
STOCK_DASHBOARD_REPORT_KOREA_CLOSE_TIME = os.getenv("STOCK_DASHBOARD_REPORT_KOREA_CLOSE_TIME", "16:10").strip() or "16:10"
STOCK_DASHBOARD_REPORT_POLL_INTERVAL_SECONDS = max(
    60,
    min(_env_int("STOCK_DASHBOARD_REPORT_POLL_INTERVAL_SECONDS", 60), 1800),
)
...
STOCK_DASHBOARD_LOGIN_CHANNEL_ID = _env_channel_id("STOCK_DASHBOARD_LOGIN_CHANNEL_ID")
STOCK_DASHBOARD_ACCESS_ROLE_GUILD_ID = _env_channel_id("STOCK_DASHBOARD_ACCESS_ROLE_GUILD_ID")
STOCK_DASHBOARD_ACCESS_ROLE_NAME = os.getenv("STOCK_DASHBOARD_ACCESS_ROLE_NAME", "★").strip() or "★"
STOCK_DASHBOARD_ACCESS_ROLE_SYNC_ENABLED = _env_bool("STOCK_DASHBOARD_ACCESS_ROLE_SYNC_ENABLED", False)
STOCK_DASHBOARD_ACCESS_ROLE_SYNC_TIME = os.getenv("STOCK_DASHBOARD_ACCESS_ROLE_SYNC_TIME", "06:10").strip() or "06:10"
...
STOCK_DASHBOARD_REPORT_GENERATION_TIMEOUT_SECONDS = max(
    10,
    min(_env_int("STOCK_DASHBOARD_REPORT_GENERATION_TIMEOUT_SECONDS", 90), 180),
)
